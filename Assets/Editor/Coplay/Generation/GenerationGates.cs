...
public static class GenerationGates
{
    ...
    public static string CheckClearance(List<PathRoute> routes, LevelBlueprint blueprint, out string summary)
    {
        ...
        // Lanes converge on the Core exactly as sieges do (no merge, designed
        // pinch at the centre), so they share the siege exemption + pair check.
        bool siege = blueprint.IsSiege || blueprint.IsLanes;
